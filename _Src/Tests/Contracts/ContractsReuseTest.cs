	...
	public abstract class ContractsReuseTest : SimpleContainerTestBase
	{
		...
		public class FinalUsedContractsForSkippedServices : ContractsReuseTest
		{
			...
			public void Test()
			{
				...
				Assert.That(container.Resolve<A>("x").GetConstructionLog(), Is.EqualTo("A[x]" + Environment.NewLine + "\tB[x] - DontUse -> <null>"));
			}
		}
		...
		public class ConstructionLogForReusedService : ContractsReuseTest
		{
			...
			public void Test()
			{
				...
				Assert.That(container.Resolve<A>().GetConstructionLog(), Is.EqualTo("A" + Environment.NewLine + "\tB" + Environment.NewLine + "\tB"));
			}
		}
